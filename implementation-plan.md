...
The behavioral contracts (spec §6) as real personas (hand-materialized, P9): Implementer MUST/HALT rules + no-web-tools; Verifier (fresh, coverage matrix, evidence-or-zero, intent-vs-actual, L3 anchored rubric → 0.0–1.0 + pass/fail); Orchestrator (guidance-only).
